...
public class Ejer01Application {
	...
	CommandLineRunner init(PersonaRepository personaRepo) {
		return args -> {
			System.out.println("-----------------ESTOY FUNCIONANDO---------");
			com.utn.ejer01.entidades.Persona persona = new com.utn.ejer01.entidades.Persona();
			...
			com.utn.ejer01.entidades.Persona personaRecuperada = personaRepository.findById(persona.getId()).orElse(null);
